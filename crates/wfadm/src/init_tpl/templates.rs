...
pub(crate) const RULES_PORT_SCAN: TemplateFile = (
    ...
    include_str!("../../templates/models/rules/01-recon/port_scan.wfl"),
);
...
pub(crate) const TOPO_SOURCES_INGRESS: TemplateFile = (
    ...
    include_str!("../../templates/topology/sources/ingress.toml"),
);
